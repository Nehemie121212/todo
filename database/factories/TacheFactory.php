...
class TacheFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'contenu'   => $this->faker->paragraph, // Paragraphe de textes aléatoires, ajouter optional car le champ contenu peut être null. Permet de simuler tous les cas
            'ordre'     => $this->faker->numberBetween(1,100), // Nombre aléatoire entre 1 et 100
            'complet'   => $this->faker->boolean, // Booléan aléatoire converti en entier
